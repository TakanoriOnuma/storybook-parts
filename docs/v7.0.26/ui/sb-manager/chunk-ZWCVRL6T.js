      ...
      (function() {
        ...
        function traverseTwoPhase(inst, fn2, arg) {
          ...
          for (i = path.length; i-- > 0; ) {
            fn2(path[i], "captured", arg);
          }
          for (i = 0; i < path.length; i++) {
            fn2(path[i], "bubbled", arg);
          }
        }
        function traverseEnterLeave(from, to, fn2, argFrom, argTo) {
          ...
          for (var i = 0; i < pathFrom.length; i++) {
            fn2(pathFrom[i], "bubbled", argFrom);
          }
          for (var _i = pathTo.length; _i-- > 0; ) {
            fn2(pathTo[_i], "captured", argTo);
          }
        }
        ...
        function mountTransition(config) {
          ...
          var start2 = mountCallback(startTransition.bind(null, setPending, config), [setPending, config]);
          return [start2, isPending];
        }
        function updateTransition(config) {
          var _updateState2 = updateState(), isPending = _updateState2[0], setPending = _updateState2[1];
          var start2 = updateCallback(startTransition.bind(null, setPending, config), [setPending, config]);
          return [start2, isPending];
        }
...
// ../components/dist/chunk-6NOPCESJ.mjs
...
function useControlledState(_ref) {
  ...
  var _React$useState = React3.useState(initial), state = _React$useState[0], setState = _React$useState[1];
  var getLatest = useGetLatest(state);
  var set = React3.useCallback(function(updater) {
...
function usePopperTooltip(config, popperOptions) {
  ...
  var defaultModifiers2 = React3.useMemo(
    function() {
      return [{
        name: "offset",
        options: {
  ...
  var _React$useState = React3.useState(null), triggerRef = _React$useState[0], setTriggerRef = _React$useState[1];
  var _React$useState2 = React3.useState(null), tooltipRef = _React$useState2[0], setTooltipRef = _React$useState2[1];
  ...
  var isTriggeredBy = React3.useCallback(
    function(trigger) {
  ...
  var hideTooltip = React3.useCallback(function() {
    clearTimeout(timer.current);
    timer.current = window.setTimeout(function() {
      return setVisible(false);
    }, finalConfig.delayHide);
  }, [finalConfig.delayHide, setVisible]);
  var showTooltip = React3.useCallback(function() {
    clearTimeout(timer.current);
    timer.current = window.setTimeout(function() {
      return setVisible(true);
    }, finalConfig.delayShow);
  }, [finalConfig.delayShow, setVisible]);
  var toggleTooltip = React3.useCallback(function() {
...
var Tooltip = import_react.default.forwardRef(
  ({ placement, hasChrome, children, arrowProps, tooltipRef, color, withArrows, ...props }, ref) => {
    return /* @__PURE__ */ import_react.default.createElement(Wrapper, { "data-testid": "tooltip", hasChrome, ref, ...props, color }, hasChrome && withArrows && /* @__PURE__ */ import_react.default.createElement(Arrow, { placement, ...arrowProps, color }), children);
  }
);
...
var WithTooltipPure = ({
  ...
  const tooltipComponent = /* @__PURE__ */ import_react.default.createElement(
    Tooltip,
    {
      placement: state?.placement,
      ref: setTooltipRef,
  ...
  return /* @__PURE__ */ import_react.default.createElement(import_react.default.Fragment, null, /* @__PURE__ */ import_react.default.createElement(Container, { trigger, ref: setTriggerRef, ...props }, children), isVisible && import_react_dom.default.createPortal(tooltipComponent, document2.body));
};
...
var WithToolTipState = ({ startOpen = false, onVisibleChange: onChange, ...rest }) => {
  ...
  return /* @__PURE__ */ import_react.default.createElement(WithTooltipPure, { ...rest, visible: tooltipShown, onVisibleChange: onVisibilityChange });
};
