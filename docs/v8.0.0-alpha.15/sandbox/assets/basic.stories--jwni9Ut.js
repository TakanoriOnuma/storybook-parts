import{f as D}from"./index-cuPYNwTH.js";const{global:A}=__STORYBOOK_MODULE_GLOBAL__,P={component:A.Components.Button,tags:["autodocs"],args:{label:"Click Me!",onClick:D()},parameters:{chromatic:{disable:!0}}},e={args:{label:"Basic"}},s={args:{label:"Disabled in DocsPage"},parameters:{docs:{disable:!0}}},a={args:{label:"Another"},parameters:{docs:{source:{type:"code"}}},play:async()=>{await new Promise(_=>_("Play function"))}};var r,o,t,n,c;e.parameters={...e.parameters,docs:{...(r=e.parameters)==null?void 0:r.docs,source:{originalSource:`{
  args: {
    label: 'Basic'
  }
...
}`,...(g=(b=a.parameters)==null?void 0:b.docs)==null?void 0:g.source},description:{story:"Another button, just to show multiple stories",...(h=(y=a.parameters)==null?void 0:y.docs)==null?void 0:h.description}}};const f=["Basic","Disabled","Another"];export{a as Another,e as Basic,s as Disabled,f as __namedExportsOrder,P as default};
