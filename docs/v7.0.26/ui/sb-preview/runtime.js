...
// ../channel-postmessage/dist/index.mjs
var dist_exports4 = {};
...
var Channel = class {
  ...
  emit(eventName, ...args2) {
    ...
    const handler = () => {
      if (this.transport) {
        this.transport.send(event, options2);
      }
...
// ../channel-websocket/dist/index.mjs
var dist_exports5 = {};
...
// ../preview-api/dist/chunk-7VOWGBKI.mjs
...
// ../preview-api/dist/chunk-3WMIYMGI.mjs
...
function u(r) {
  return r.replace(/_/g, " ").replace(/-/g, " ").replace(/\./g, " ").replace(/([^\n])([A-Z])([a-z])/g, (e, t, n, a) => `${t} ${n}${a}`).replace(/([a-z])([A-Z])/g, (e, t, n) => `${t} ${n}`).replace(/([a-z])([0-9])/gi, (e, t, n) => `${t} ${n}`).replace(/([0-9])([a-z])/gi, (e, t, n) => `${t} ${n}`).replace(/(\s|^)(\w)/g, (e, t, n) => `${t}${n.toUpperCase()}`).replace(/ +/g, " ").trim();
}
var c = P(x());
...
var GlobalsStore = class {
  ...
  set({ globals: globals2 = {}, globalTypes = {} }) {
    ...
    this.allowedGlobalNames = /* @__PURE__ */ new Set([...Object.keys(globals2), ...Object.keys(globalTypes)]);
  ...
  filterAllowedGlobals(globals2) {
    return Object.entries(globals2).reduce((acc, [key2, value2]) => {
...
function prepareContext(context) {
  ...
  const includedArgs = Object.entries(mappedArgs).reduce((acc, [key2, val]) => {
    ...
    if (v(argType, mappedArgs, targetedContext.globals))
      acc[key2] = val;
    return acc;
  }, {});
...
// ../preview-api/dist/chunk-REFJLGBC.mjs
...
// ../preview-api/dist/chunk-GOH3FKVU.mjs
...
var PreviewWithSelection = class extends Preview {
  ...
  async setInitialGlobals() {
    ...
    if (globals2) {
      this.storyStore.globals.updateFromPersisted(globals2);
    }
    this.emitGlobals();
  }
  // If initialization gets as far as the story index, this function runs.
...
var getQueryString = ({
  ...
  const { search = "" } = document2.location;
...
var getSelectionSpecifierFromPath = () => {
  const query = import_qs3.default.parse(document2.location.search, { ignoreQueryPrefix: true });
  const args2 = typeof query.args === "string" ? parseArgsParam(query.args) : void 0;
  const globals2 = typeof query.globals === "string" ? parseArgsParam(query.globals) : void 0;
  ...
  if (storyId) {
    return { storySpecifier: storyId, args: args2, globals: globals2, viewMode };
  }
  return null;
};
var UrlStore = class {
...
// ../preview-api/dist/chunk-R6BKKAZL.mjs
