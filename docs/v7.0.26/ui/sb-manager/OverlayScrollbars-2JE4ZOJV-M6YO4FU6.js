...
// ../components/dist/OverlayScrollbars-2JE4ZOJV.mjs
...
var OverlayScrollbarsComponent = ({
  ...
  const osTargetRef = (0, import_react.useRef)();
  const osInstance = (0, import_react.useRef)();
  ...
  return /* @__PURE__ */ import_react.default.createElement("div", { className: "os-host", ...rest, ref: osTargetRef }, /* @__PURE__ */ import_react.default.createElement("div", { className: "os-resize-observer-host" }), /* @__PURE__ */ import_react.default.createElement("div", { className: "os-padding" }, /* @__PURE__ */ import_react.default.createElement("div", { className: "os-viewport" }, /* @__PURE__ */ import_react.default.createElement("div", { className: "os-content" }, children))), /* @__PURE__ */ import_react.default.createElement("div", { className: "os-scrollbar os-scrollbar-horizontal " }, /* @__PURE__ */ import_react.default.createElement("div", { className: "os-scrollbar-track" }, /* @__PURE__ */ import_react.default.createElement("div", { className: "os-scrollbar-handle" }))), /* @__PURE__ */ import_react.default.createElement("div", { className: "os-scrollbar os-scrollbar-vertical" }, /* @__PURE__ */ import_react.default.createElement("div", { className: "os-scrollbar-track" }, /* @__PURE__ */ import_react.default.createElement("div", { className: "os-scrollbar-handle" }))), /* @__PURE__ */ import_react.default.createElement("div", { className: "os-scrollbar-corner" }));
};
