import{j as o,a as d}from"./jsx-runtime-0f39435c.js";import{d as w}from"./index-356e4a49.js";import{s as T}from"./index-d475d2ea.js";import{r as c}from"./index-6f814c40.js";import{e as i}from"./index-5a529529.js";import"./_commonjsHelpers-042e6b4d.js";const{document:X}=T,C=i.strong(({theme:e})=>({color:e.color.orange})),F=i.strong(({theme:e})=>({color:e.color.ancillary,textDecoration:"underline"})),u=i.em(({theme:e})=>({color:e.textMutedColor})),W=/(Error): (.*)\n/,R=/at (?:(.*) )?\(?(.+)\)?/,I=/([^@]+)?(?:\/<)?@(.+)?/,G=/([^@]+)?@(.+)?/,h=({error:e})=>{if(!e)return o(c.Fragment,{children:"This error has no stack or message"});if(!e.stack)return o(c.Fragment,{children:e.message||"This error has no stack or message"});let s=e.stack.toString();s&&e.message&&!s.includes(e.message)&&(s=`Error: ${e.message}

${s}`);const p=s.match(W);if(!p)return o(c.Fragment,{children:s});const[,L,S]=p,x=s.split(/\n/).slice(1),[,...J]=x.map(t=>{const r=t.match(R)||t.match(I)||t.match(G);return r?{name:(r[1]||"").replace("/<",""),location:r[2].replace(X.location.origin,"")}:null}).filter(Boolean);return d(c.Fragment,{children:[o("span",{children:L}),": ",o(C,{children:S}),o("br",{}),J.map((t,r)=>t.name?d(c.Fragment,{children:["  ","at ",o(F,{children:t.name})," (",o(u,{children:t.location}),")",o("br",{})]},r):d(c.Fragment,{children:["  ","at ",o(u,{children:t.location}),o("br",{})]},r))]})};try{h.displayName="ErrorFormatter",h.__docgenInfo={description:"",displayName:"ErrorFormatter",props:{error:{defaultValue:null,description:"",name:"error",required:!0,type:{name:"Error"}}}}}catch{}const $={component:h,decorators:[e=>o("pre",{children:o(e,{})})]},E=new Error("Rendering Problem");E.stack=`Error: Rendering problem
...
}`,...(k=(v=a.parameters)==null?void 0:v.docs)==null?void 0:k.source}}};var b,f,y;n.parameters={...n.parameters,docs:{...(b=n.parameters)==null?void 0:b.docs,source:{originalSource:`{
  args: {
    error: safariError
  }
}`,...(y=(f=n.parameters)==null?void 0:f.docs)==null?void 0:y.source}}};var j,_,H;l.parameters={...l.parameters,docs:{...(j=l.parameters)==null?void 0:j.docs,source:{originalSource:`{
  args: {
    error: firefoxError
  }
}`,...(H=(_=l.parameters)==null?void 0:_.docs)==null?void 0:H.source}}};const N=["Chrome","Safari","Firefox"];export{a as Chrome,l as Firefox,n as Safari,N as __namedExportsOrder,$ as default};
//# sourceMappingURL=ErrorFormatter.stories-85cbb158.js.map
