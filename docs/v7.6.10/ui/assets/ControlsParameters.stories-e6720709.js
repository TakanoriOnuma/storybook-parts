import{j as S}from"./jsx-runtime-31019b9d.js";import"./index-9f32f44c.js";import"./_commonjsHelpers-de833af9.js";const s=({a:f="a",b})=>S("div",{children:"Example story"});try{s.displayName="ControlsParameters",s.__docgenInfo={description:"",displayName:"ControlsParameters",props:{a:{defaultValue:{value:"a"},description:"",name:"a",required:!1,type:{name:"string"}},b:{defaultValue:null,description:"",name:"b",required:!0,type:{name:"string"}}}}}catch{}const P={title:"examples/Stories for the Controls Block",component:s,args:{b:"b"},argTypes:{extraMetaArgType:{type:{name:"string"},name:"Extra Meta",description:"An extra argtype added at the meta level",table:{defaultValue:{summary:"'a default value'"}}}},parameters:{docs:{description:{component:"Reference stories to be used by the Controls stories"}}}},e={argTypes:{extraStoryArgType:{type:{name:"string"},name:"Extra Story",description:"An extra argtype added at the story level",table:{defaultValue:{summary:"'a default value'"}}}}},r={...e,parameters:{docs:{controls:{include:["a"]}}}},a={...e,parameters:{docs:{controls:{exclude:["a"]}}}},t={...e,parameters:{docs:{controls:{sort:"alpha"}}}};var o,n,c;e.parameters={...e.parameters,docs:{...(o=e.parameters)==null?void 0:o.docs,source:{originalSource:`{
  argTypes: {
...
//# sourceMappingURL=ControlsParameters.stories-e6720709.js.map
