...
// ../components/dist/formatter-HRJTHH5C.mjs
...
function Nn2(e, t8) {
  ...
  for (let [p, l] of f2.entries()) {
    ...
    if (i ? $ = [l] : (F2.enclosingNode = E2, F2.precedingNode = m, F2.followingNode = C, $ = [F2, g, h2, B, Z]), Co2(g, h2, f2, p))
      F2.placement = "ownLine", a(...$) || (C ? ne2(C, F2) : m ? ue2(m, F2) : E2 ? X2(E2, F2) : X2(B, F2));
    else if (ho2(g, h2, f2, p))
      F2.placement = "endOfLine", c(...$) || (m ? ue2(m, F2) : C ? ne2(C, F2) : E2 ? X2(E2, F2) : X2(B, F2));
    else if (F2.placement = "remaining", !d(...$))
      if (m && C) {
        let Q2 = n.length;
        Q2 > 0 && n[Q2 - 1].followingNode !== C && wn2(n, h2), n.push(l);
      } else
        m ? ue2(m, F2) : C ? ne2(C, F2) : E2 ? X2(E2, F2) : X2(B, F2);
  }
  if (wn2(n, t8), !i)
    for (let p of r)
